...
const FREE_FEATURES = ["60 işleme kadar", "Sınırsız kredi kartı ve kredi", "5 taksitli plan", "Temel raporlar", "CSV / JSON dışa aktarma"];
const PREMIUM_FEATURES = ["Sınırsız işlem ve taksit", "Ortak hesap (eş daveti)", "AI Finans Asistanı", "PDF / Excel dışa aktarma", "Ekstre içe aktarma", "Gelişmiş bildirimler"];
