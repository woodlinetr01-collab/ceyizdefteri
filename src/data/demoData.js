...
import { generateInstallmentLines } from "../lib/financeEngine.js";
...
export function buildEmptyState() {
  return {
    ...
    categoryBudgets: {},
    trash: [],
    meta: { dataMode: "empty", onboarded: true, createdAt: nowIso() },
  };
}
...
export function buildDemoState() {
  ...
  const cards = [
    { id: "card_garanti", name: "Garanti Bonus", bank: "Garanti BBVA", limit: 100000, statementDay: 15, dueDay: 22, existingDebt: 0, deletedAt: null },
    { id: "card_akbank", name: "Akbank Axess", bank: "Akbank", limit: 150000, statementDay: 5, dueDay: 12, existingDebt: 15000, deletedAt: null },
  ];
  ...
  return {
    transactions, installments, cards, debts, recurringRules, categoryBudgets, trash: [],
    meta: { dataMode: "demo", onboarded: true, createdAt: nowIso() },
  };
}
